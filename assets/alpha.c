// Tile sheet for ASCII characters 0x30 through 0x5F
// Taken from https://videlais.com/2016/07/05/programming-game-boy-games-using-gbdk-part-3-using-gbtd-and-gbmb/
